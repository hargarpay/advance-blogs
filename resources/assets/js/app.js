...
$(document).ready(function () {
  ...
  $("td.actions-button a.btn:not('.btn-info, .non-script')").on('click', function(e){
      e.preventDefault();
      $this = $(this);
      if($this.hasClass('btn-danger')){
          $('form#delete-method').attr('action', $this.data('href')).submit();
      }else if($this.hasClass('btn-default') || $this.hasClass('btn-warning') || $this.hasClass('btn-success') )
      {
